...
export const useTextInputState = ({ defaultValue = "", suggestions, onChange, onSubmit }: UseTextInputStateProps) => {
  ...
  const suggestion = useMemo(() => {
    ...
    return suggestions?.find((suggestion) => suggestion.startsWith(state.value))?.replace(state.value, "");
